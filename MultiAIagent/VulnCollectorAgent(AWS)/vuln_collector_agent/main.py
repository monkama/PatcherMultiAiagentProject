...
try:
    ...
    from vuln_collector_agent.tools.cve_fetcher import fetch_selected_raw_cve_record
    from vuln_collector_agent.tools.cwe_fetcher import fetch_cwe_weakness_summary
    from vuln_collector_agent.tools.evidence_fetcher import fetch_operational_evidence
    from vuln_collector_agent.tools.output_writer import save_vulnerability_result
    from vuln_collector_agent.tools.payload_builder import (
        build_operational_impact_payloads,
        build_risk_assessment_payloads,
    )
