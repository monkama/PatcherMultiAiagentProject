...
def call_bedrock_text(
    *,
    ...
    """Call Bedrock Converse API and return text content.

    This helper intentionally returns raw text. JSON extraction/validation stays in
    each agent stage because the required schema differs by stage.
    """
