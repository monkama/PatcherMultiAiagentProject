...
- 프로젝트 루트 [\.env](/Users/jms/Desktop/project/PacherAgents/.env)에 AWS 인증, OpenAI 키, 오케스트레이터 ARN이 있어야 합니다.
...
- `OPENAI_MODEL`은 반드시 **`gpt-4.1` 이상**을 사용하십시오.
- `gpt-4.1-mini` 같은 mini 계열은 자산 사실 확인, 위험도 평가, 패치 전략 판단 품질이 흔들릴 수 있으므로 **사용하지 마십시오.**
